...
const sunWebBuilder = require('../helpers/sunWebBuilder');
const assertEqualHex = require('../helpers/assertEqualHex');
const TronWeb = sunWebBuilder.mainchain;
...
describe('TronWeb.trx', function () {
    ...
    before(async function () {
        tronWeb = sunWebBuilder.createInstance().mainchain;
        // ALERT this works only with Tron Quickstart:
        accounts = await sunWebBuilder.getTestAccounts(-1);
